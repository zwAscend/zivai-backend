package zw.co.zivai.core_backend.aspects;
...
public class StudentSubjectEnrolmentAspect {
    ...
    @AfterReturning(
        pointcut = "execution(* zw.co.zivai.core_backend.repositories.classroom.StudentSubjectEnrolmentRepository.save(..))",
        returning = "result"
    )
    ...
    @AfterReturning(
        pointcut = "execution(* zw.co.zivai.core_backend.repositories.classroom.StudentSubjectEnrolmentRepository.saveAndFlush(..))",
        returning = "result"
    )
    ...
    @AfterReturning(
        pointcut = "execution(* zw.co.zivai.core_backend.repositories.classroom.StudentSubjectEnrolmentRepository.saveAll(..)) || " +
            "execution(* zw.co.zivai.core_backend.repositories.classroom.StudentSubjectEnrolmentRepository.saveAllAndFlush(..))",
        returning = "result"
    )
