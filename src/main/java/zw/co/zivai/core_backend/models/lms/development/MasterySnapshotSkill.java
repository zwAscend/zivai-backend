package zw.co.zivai.core_backend.models.lms.development;
...
import zw.co.zivai.core_backend.models.lms.students.StudentDocument;
...
public class MasterySnapshotSkill {
    ...
    private StudentDocument.MasterySnapshot masterySnapshot;
